...
#: :py:const:`feature_min_gene_fraction` and
...
#: :py:const:`noisy_lonely_max_gene_similarity` and
...
#: py:const:`rare_min_cell_module_total` and
...
#: :py:const:`excess_downsample_cell_quantile` and
...
#: :py:func:`metacells.pipeline.divide_and_conquer.compute_divide_and_conquer_metacells`,
#: :py:func:`metacells.pipeline.complete.direct_pipeline`
#: and
#: :py:func:`metacells.pipeline.complete.divide_and_conquer_pipeline`.
...
#: :py:const:`pile_min_split_size_factor` and
...
#: :py:const:`pile_min_robust_size_factor` and
...
#: :py:const:`pile_max_merge_size_factor` and
...
#: :py:const:`downsample_cell_quantile` and
