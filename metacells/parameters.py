...
#: :py:func:`metacells.tools.outliers.find_outlier_cells` and
#: :py:func:`metacells.tools.dissolve.dissolve_metacells`.
significant_gene_fold_factor: float = 3.0

#: The generic minimal value (number of UMIs) we can say is "significant" given the technical
#: noise. See :py:func:`metacells.tools.rare.find_rare_genes_modules` and
...
#: purpose. See :py:func:`metacells.tools.downsample.downsample_cells`,
#: :py:func:`metacells.tools.noisy_lonely.find_noisy_lonely_genes`,
#: :py:func:`metacells.pipeline.direct.extract_feature_data`, and
...
#: :py:func:`metacells.tools.rare.find_rare_genes_modules`. Note this is different from the
#: lower :py:const:`significant_gene_fraction` which applies to the mean expression of the gene
#: across the cells.
...
#: :py:func:`metacells.tools.rare.find_rare_genes_modules`. Note this is different from the
#: higher :py:const:`significant_gene_similarity` which applies to the maximal correlation
...
#: expressing it. See :py:const:`significant_value` and
#: :py:func:`metacells.tools.rare.find_rare_genes_modules`.
...
#: "feature" genes. See :py:const:`downsample_cell_quantile` and
#: :py:func:`metacells.pipeline.direct.extract_feature_data`.
...
#: K-Nearest-Neighbors graph. See :py:const:`min_split_size_factor` and
#: :py:func:`metacells.tools.candidates.compute_candidate_metacells`.
...
#: K-Nearest-Neighbors graph. See :py:const:`max_merge_size_factor` and
#: :py:func:`metacells.utilities.partition.PartitionMethod`.
...
#: :py:const:`significant_gene_fold_factor` and
...
#: :py:const:`target_metacell_size` and :py:func:`metacells.tools.dissolve.dissolve_metacells`.
...
#: :py:const:`min_robust_size_factor` and
#: :py:func:`metacells.tools.dissolve.dissolve_metacells`.
...
#: R^2 for the genes. See :py:const:`downsample_cell_quantile` and
#: :py:func:`metacells.tools.excess.compute_excess_r2`.
