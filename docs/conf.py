#!/usr/bin/env python3
#
# Metacells documentation build configuration file, created by
...
nitpick_ignore = [
    ...
    ('py:class', 'metacells.utilities.computation.S'),
    ('py:class', 'metacells.utilities.documentation.CALLABLE'),
    ('py:class', 'metacells.utilities.logging.CALLABLE'),
    ('py:class', 'metacells.utilities.parallel.T'),
    ('py:class', 'metacells.utilities.timing.CALLABLE'),
